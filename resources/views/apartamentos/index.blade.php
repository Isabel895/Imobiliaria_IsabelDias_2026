...
<form method="GET" class="row g-2 mb-3">
    <div class="col-md-4">
        <input type="text" name="search" class="form-control" placeholder="Pesquisar por referência, tipologia ou morada..."
...
<table class="table table-striped table-bordered">
    <thead class="table-dark">
        <tr>
            <th>ID</th><th>Ref.</th><th>Tipologia</th><th>Morada</th>
            <th>Área (m²)</th><th>Preço</th><th>Estado</th><th>Ações</th>
        </tr>
    </thead>
    <tbody>
        ...
        @empty
        <tr><td colspan="8" class="text-center">Nenhum apartamento encontrado.</td></tr>
        @endforelse
    </tbody>
</table>
@endsection
